        ...
        <g transform="translate({margin.left}, {margin.top})">
            ...
            {#if maxBar}
                ...
                <line
                    ...
                    y1={yScale(maxBar.value) + (innerHeight - yScale(maxBar.value)) - 100}
                    x2={xScale(maxBar.label) + xScale.bandwidth() + 30}
                    y2={yScale(maxBar.value) + (innerHeight - yScale(maxBar.value)) - 100}
                    stroke="currentColor"
                    stroke-width="1"
                />
                ...
                <text
                    ...
                    y={yScale(maxBar.value) + (innerHeight - yScale(maxBar.value)) - 100}
